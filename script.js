      ...
      wrapper.innerHTML = `
        ...
        <div class="horizontal-flex-div">
          <h4>Project Gallery</h4><h6>Tap image to visit the GitHub repository.  There you will find a link to the project demo if applicable.</h6>
            <div class="parentDiv">
              <div class="project scale"><p>JavaScript: Matthew Miles - Portfolio Site</p><a href="https://github.com/milesmgit/responsive-portfolio" target="_blank"><img src="img/responsive1.png" onmouseover="rollover(this)" onmouseout="rollout()" alt="Portfolio Site" width="300" height="200" title="JavaScript: - Matthew Miles - Portfolio Site"></a></div>
